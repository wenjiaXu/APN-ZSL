...
## Contents:
**(1)** Code for ZSL(GZSL) on three bench mark datasets CUB, AwA2, SUN (will come up soon).

**(2)** Trained image representations that can boost performance of other generative models (will come up soon).
